  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Universidad Católica Sedes Sapientae', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text('Código de estudiante: ${LoginController.sesionAlumno!.codigo}', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
              ),
              SizedBox(height: 15,),
              ClipRRect(borderRadius: BorderRadius.circular(50), child: Image.network(controllerImg.fotoPerfilAlumno(), width: 200, height: 300, fit: BoxFit.cover),),
              SizedBox(height: 15,),
              BarcodeWidget(
                barcode: Barcode.code128(), 
                data: '${LoginController.sesionAlumno!.codigo} ${LoginController.sesionAlumno!.apellidoPaterno}',
                width: 300, 
                height: 100, 
                drawText: false,
              ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(LoginController.sesionAlumno!.getLabels(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold), textAlign: TextAlign.right,),
                    SizedBox(width: 10,),
                    Text(LoginController.sesionAlumno!.getValues(), style: TextStyle(fontSize: 14))
                  ],
                ),
              ),
              SizedBox(height: 15,),
